...
macro_rules! cons_ident {
    ($ident:ident $(, $idents:ident)+) => {
        crate::t_funk::collection::hlist::Cons($ident, crate::cons_ident!($($idents),*))
    };
    ($ident:ident) => {
        crate::t_funk::collection::hlist::Cons($ident, crate::t_funk::collection::hlist::Nil)
    };
    () => {};
}
...
macro_rules! cons_ty {
    ($ty:ty $(, $tys:ty)+) => {
        crate::t_funk::collection::hlist::Cons<$ty, crate::cons_ty!($($tys),*)>
    };
    ($ty:ty) => {
        crate::t_funk::collection::hlist::Cons<$ty, crate::t_funk::collection::hlist::Nil>
    };
    () => {};
}
